...
- See [docs/aircommandrockets_simulator_rocket_a.pdf](https://github.com/zerneo85/ESP-Controlled-Rocket/docs/aircommandrockets_simulator_rocket_a.pdf) for simulation results
...
- See [docs/aircommandrockets_simulator_rocket_b.pdf](https://github.com/zerneo85/ESP-Controlled-Rocket/docs/aircommandrockets_simulator_rocket_b.pdf) for simulation results
...
- **Web-Based File Management**  
  Lets you view, upload, download, or delete files from both SD card and SPIFFS through the web UI ([flight-computer/data/index.html](https://github.com/zerneo85/ESP-Controlled-Rocket/flight-computer/data/index.html)).
- **3D Visualization Support**  
...
See [`flight-computer/flight-computer.ino`](https://github.com/zerneo85/ESP-Controlled-Rocket/flight-computer/flight-computer.ino) and related modules for implementation details.
...
![All dashboards video](https://github.com/zerneo85/ESP-Controlled-Rocket/media/all_dashboards.gif)  
![Flight Computer Screenshot](https://github.com/zerneo85/ESP-Controlled-Rocket/media/flight_computer_dashboard_0.png)  
![File Manager Screenshot](https://github.com/zerneo85/ESP-Controlled-Rocket/media/filemanager_dashboard_1.png)  
![Visualization Screenshot](https://github.com/zerneo85/ESP-Controlled-Rocket/media/visualization_dashboard_1.png)
![Impression A](https://github.com/zerneo85/ESP-Controlled-Rocket/media/impression_a.jpeg)
![Impression E](https://github.com/zerneo85/ESP-Controlled-Rocket/media/impression_e.jpeg)
![Payload Parachute Release Video](https://github.com/zerneo85/ESP-Controlled-Rocket/media/Payload_Parachute_Release_Compressed.gif)  
...
For the **complete list with detailed descriptions and references**, see [docs/3d_parts_overview.md](https://github.com/zerneo85/ESP-Controlled-Rocket/docs/3d_parts_overview.md).
...
See [`docs/assembly_guide.md`](https://github.com/zerneo85/ESP-Controlled-Rocket/docs/assembly_guide.md) for wiring, assembly, and mounting tips.
...
1. **WiFi Configuration:**  
   - Edit WiFi credentials in [`flight-computer/flight-computer.ino`](https://github.com/zerneo85/ESP-Controlled-Rocket/flight-computer/flight-computer.ino)
...
4. **Changing Triggers:**  
   - All parachute triggers (arming/release altitude, speed, time) can be set via the web interface, or changed in the config section of [`flight-computer.ino`](https://github.com/zerneo85/ESP-Controlled-Rocket/flight-computer/flight-computer.ino).
...
To change default trigger parameters in code, edit the config section in [`flight-computer/flight-computer.ino`](https://github.com/zerneo85/ESP-Controlled-Rocket/flight-computer/flight-computer.ino).
...
|-----------|--------------------------------------------------------------------- |----------- |---------- |--------------- |------------ |------------------ |-------------|
| Rocket A  | [docs/aircommandrockets_simulator_rocket_a.pdf](https://github.com/zerneo85/ESP-Controlled-Rocket/docs/aircommandrockets_simulator_rocket_a.pdf) | 1.5        | 0.5      | 198           | 7          | 67.7             | Mechanical  |
| Rocket B  | [docs/aircommandrockets_simulator_rocket_b.pdf](https://github.com/zerneo85/ESP-Controlled-Rocket/docs/aircommandrockets_simulator_rocket_b.pdf) | 4.5        | 1.0      | 803           | 7          | 50.0             | ESP32/auto  |

- *See PDFs in [`docs/`](https://github.com/zerneo85/ESP-Controlled-Rocket/docs/) for full simulation graphs and breakdown.*
...
- [`docs/aircommandrockets_simulator_rocket_a.pdf`](https://github.com/zerneo85/ESP-Controlled-Rocket/docs/aircommandrockets_simulator_rocket_a.pdf) (Rocket A)
- [`docs/aircommandrockets_simulator_rocket_b.pdf`](https://github.com/zerneo85/ESP-Controlled-Rocket/docs/aircommandrockets_simulator_rocket_b.pdf) (Rocket B)
...
See [`docs/rocket_parts.xlsx`](https://github.com/zerneo85/ESP-Controlled-Rocket/docs/rocket_parts.xlsx) for weight of the individual parts.
